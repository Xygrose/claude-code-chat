...
const getHtml = (isTelemetryEnabled: boolean, nonce: string, cspSource: string) => {
	const umamiOrigin = 'https://cloud.umami.is';
	const scriptSrc = isTelemetryEnabled ? `'nonce-${nonce}' ${umamiOrigin}` : `'nonce-${nonce}'`;
	const connectSrc = isTelemetryEnabled ? umamiOrigin : `'none'`;
...
<body>
	...
	<div class="cr-header minimal">
		<div class="cr-header-left">
			...
			<!-- Tab Navigation -->
			<div class="cr-tabs">
				<button class="cr-tab active" id="tabChat" data-action="switchTab" data-tab="chat">Chat</button>
				<button class="cr-tab panel-toggle" id="tabAgents" data-action="toggleAgentPanel">Control Panel</button>
			</div>
		</div>
		<div class="cr-header-right">
			<span class="cr-stats" id="globalStats" style="font-size: 11px; color: var(--cr-text-muted);">$0.00</span>
			<button class="btn icon" id="historyBtn" data-action="toggleConversationHistory" title="History">
				<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
					<path d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z"/>
				</svg>
			</button>
			<button class="btn icon" id="settingsBtn" data-action="toggleSettings" title="Settings">
				<svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
	...
	<div class="cr-main">
		...
		<div class="cr-view cr-chat-view active" id="chatView">
					...
					<div id="wslAlert" class="wsl-alert" style="display: none;">
						<div class="wsl-alert-content">
							...
							<div class="wsl-alert-actions">
								<button class="btn primary small" data-action="openWSLSettings">Enable</button>
								<button class="btn secondary small" data-action="dismissWSLAlert">Dismiss</button>
							</div>
						</div>
					</div>
				</div>
			...
			<div class="input-container streamlined" id="inputContainer" style="position: relative;">
				...
				<div class="textarea-container">
					<div class="textarea-wrapper">
						...
						<div class="input-controls">
							<div class="left-controls">
								<button class="model-selector" id="modelSelector" data-action="showModelSelector" title="Select model">
									<span id="selectedModel">Opus</span>
									<svg width="8" height="8" viewBox="0 0 8 8" fill="currentColor">
										<path d="M1 2.5l3 3 3-3"></path>
									</svg>
								</button>
								<button class="tools-btn" data-action="showMCPModal" title="Configure MCP servers">
									MCP
									<svg width="8" height="8" viewBox="0 0 8 8" fill="currentColor">
										<path d="M1 2.5l3 3 3-3"></path>
									</svg>
							...
							<div class="right-controls">
								<button class="slash-btn" data-action="triggerSlashCommands" title="Commands">/</button>
								<button class="at-btn" data-action="showFilePicker" title="Files">@</button>
								<button class="image-btn" id="imageBtn" data-action="selectImage" title="Images">
								...
								<button class="send-btn" id="sendBtn" data-action="sendMessage">
					...
					<button class="btn danger small" id="stopBtn" data-action="stopRequest" style="display: none; margin-left: 8px;">
						Stop
					</button>
				</div>
				...
				<div class="mode-toggle-bar">
					<div class="mode-toggle-container">
						<button class="mode-toggle-option" data-action="setEditMode" data-mode="plan" title="Plan changes without making edits">
						...
						<button class="mode-toggle-option" data-action="setEditMode" data-mode="auto" title="Automatically apply edits">
							<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
						...
						<div class="mode-toggle-separator"></div>
						<button class="mode-toggle-option active" data-action="setEditMode" data-mode="ask" title="Ask before making edits">
							<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
		...
		<div class="cr-view cr-agents-view" id="agentsView" style="display: none !important;">
			<div class="cr-agents-header">
				...
				<button class="btn primary" id="newAgentBtn" data-action="newSession">+ New Agent</button>
			</div>
			<div class="cr-agents-grid" id="agentList">
				<!-- Agent Card -->
				<div class="agent-card grid-card selected" id="agent-default" data-action="selectAgentAndSwitch" data-agent-id="default">
	...
	<!-- ========================================
	     ...
	     ======================================== -->
	<div class="agent-panel-overlay" id="agentPanelOverlay" data-action="toggleAgentPanel"></div>

	<div class="agent-panel" id="agentPanel">
		<div class="agent-panel-header">
			<span class="agent-panel-title">Control Panel</span>
			<button class="agent-panel-close" data-action="toggleAgentPanel" title="Close panel">
		...
		<div class="agent-panel-content" id="agentPanelList">
			...
			<div class="agent-card selected" id="panel-agent-default" data-action="selectAgentFromPanel" data-agent-id="default">
				<div class="agent-card-header">
					<span class="agent-name">Agent 1</span>
		...
		<div class="agent-panel-footer">
			<button class="new-agent-btn" data-action="newSession">
	...
	<div id="conversationHistory" class="conversation-history" style="display: none;">
		<div class="conversation-header">
			...
			<button class="btn icon" data-action="toggleConversationHistory">
				<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
					<path d="M6 18L18 6M6 6l12 12"/>
				</svg>
			</button>
	...
	<div id="mcpModal" class="modal tools-modal" style="display: none;">
		<div class="modal-content tools-modal-content">
			<div class="modal-header tools-modal-header">
				...
				<button class="btn icon close-btn" data-action="hideMCPModal">
					<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
						<path d="M6 18L18 6M6 6l12 12"/>
					</svg>
				</button>
			...
			<div class="tools-list">
				...
				<div class="mcp-add-server">
					<button class="btn secondary" data-action="showAddServerForm" id="addServerBtn">+ Add MCP Server</button>
				</div>
				<div class="mcp-popular-servers" id="popularServers">
					<h4>Popular MCP Servers</h4>
					<div class="popular-servers-grid">
						<div class="popular-server-item" data-action="addPopularServer" data-server-id="context7">
						...
						<div class="popular-server-item" data-action="addPopularServer" data-server-id="sequential-thinking">
							<div class="popular-server-icon">
						...
						<div class="popular-server-item" data-action="addPopularServer" data-server-id="memory">
							<div class="popular-server-icon">
						...
						<div class="popular-server-item" data-action="addPopularServer" data-server-id="puppeteer">
							<div class="popular-server-icon">
						...
						<div class="popular-server-item" data-action="addPopularServer" data-server-id="fetch">
							<div class="popular-server-icon">
								<svg width="16" height="16" viewBox="0 0 24 24" fill="currentColor"><path d="M12 2C6.48 2 2 6.48 2 12s4.48 10 10 10 10-4.48 10-10S17.52 2 12 2zm-1 17.93c-3.95-.49-7-3.85-7-7.93 0-.62.08-1.21.21-1.79L9 15v1c0 1.1.9 2 2 2v1.93zm6.9-2.54c-.26-.81-1-1.39-1.9-1.39h-1v-3c0-.55-.45-1-1-1H8v-2h2c.55 0 1-.45 1-1V7h2c1.1 0 2-.9 2-2v-.41c2.93 1.19 5 4.06 5 7.41 0 2.08-.8 3.97-2.1 5.39z"/></svg>
							</div>
							<div class="popular-server-info">
						...
						<div class="popular-server-item" data-action="addPopularServer" data-server-id="filesystem">
							<div class="popular-server-icon">
				...
				<div class="mcp-add-form" id="addServerForm" style="display: none;">
					...
					<div class="form-buttons">
						<button class="btn primary" data-action="saveMCPServer">Add Server</button>
						<button class="btn secondary" data-action="hideAddServerForm">Cancel</button>
					</div>
				</div>
			</div>
		</div>
	...
	<div id="settingsModal" class="modal tools-modal" style="display: none;">
		<div class="modal-content tools-modal-content">
			<div class="modal-header tools-modal-header">
				<span>Settings</span>
				<button class="btn icon close-btn" data-action="hideSettingsModal">
					<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
						<path d="M6 18L18 6M6 6l12 12"/>
					</svg>
				</button>
			...
			<div class="tools-list settings-list">
				<div class="settings-section">
					...
					<div class="settings-group">
						<div class="tool-item">
							<input type="checkbox" id="wsl-enabled">
						...
						<div id="wslOptions" class="wsl-options" style="display: none;">
							...
							<div class="form-group">
								...
								<input type="text" id="wsl-claude-path" class="form-input" placeholder="/usr/local/bin/claude">
								<p class="form-hint">
						...
						<div class="permissions-add-section">
							<div id="addPermissionForm" class="permissions-add-form" style="display: none;">
								<div class="permissions-form-row">
									...
									<button id="addPermissionBtn" class="btn primary small permissions-add-btn" data-action="addPermission">Add</button>
								</div>
								<div id="permissionsFormHint" class="permissions-form-hint">
									Select a tool to add always-allow permission.
								</div>
							</div>
							<button id="showAddPermissionBtn" class="btn secondary permissions-show-add-btn" data-action="showAddPermissionForm">
								+ Add permission
							</button>
	...
	<div id="modelModal" class="modal tools-modal" style="display: none;">
		<div class="modal-content tools-modal-content model-modal-content">
			<div class="modal-header tools-modal-header">
				...
				<button class="btn icon close-btn" data-action="hideModelModal">
					<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
						<path d="M6 18L18 6M6 6l12 12"/>
					</svg>
				</button>
			...
			<div class="tools-list model-list">
				<div class="tool-item model-item" data-action="selectModel" data-model="opus">
				...
				<div class="tool-item model-item" data-action="selectModel" data-model="sonnet">
				...
				<div class="tool-item model-item" data-action="selectModel" data-model="default">
					...
					<label for="model-default" class="default-model-layout">
						...
						<button class="btn secondary small configure-button" data-action="openModelTerminal">
							Configure
						</button>
					</label>
				</div>
	...
	<div id="installModal" class="modal install-modal" style="display: none;">
		<div class="install-modal-backdrop" data-action="hideInstallModal"></div>
		<div class="modal-content install-modal-content">
			<button class="btn icon close-btn install-close-btn" data-action="hideInstallModal">
			...
			<div class="install-body" id="installBody">
				<div class="install-main" id="installMain">
					...
					<button class="btn primary install-btn" id="installMainBtn" data-action="startInstallation">
						Install Now
					</button>
	...
	<div id="thinkingIntensityModal" class="modal tools-modal" style="display: none;">
		<div class="modal-content tools-modal-content thinking-modal-content">
			<div class="modal-header tools-modal-header">
				...
				<button class="btn icon close-btn" data-action="hideThinkingIntensityModal">
					<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
						<path d="M6 18L18 6M6 6l12 12"/>
					</svg>
				</button>
			...
			<div class="tools-list">
				<div class="thinking-slider-container">
					<input type="range" min="0" max="3" value="0" step="1" class="thinking-slider" id="thinkingIntensitySlider">
					<div class="slider-labels">
						<div class="slider-label active" id="thinking-label-0" data-action="setThinkingIntensityValue" data-intensity="0">Think</div>
						<div class="slider-label" id="thinking-label-1" data-action="setThinkingIntensityValue" data-intensity="1">Think Hard</div>
						<div class="slider-label" id="thinking-label-2" data-action="setThinkingIntensityValue" data-intensity="2">Think Harder</div>
						<div class="slider-label" id="thinking-label-3" data-action="setThinkingIntensityValue" data-intensity="3">Ultrathink</div>
					</div>
				</div>
				<div class="thinking-modal-actions">
					<button class="btn primary confirm-btn" data-action="confirmThinkingIntensity">Confirm</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="slashCommandsModal" class="modal tools-modal" style="display: none;">
			<div class="modal-content tools-modal-content slash-modal-content">
				...
				<button class="btn icon close-btn" data-action="hideSlashCommandsModal">
					<svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
						<path d="M6 18L18 6M6 6l12 12"/>
					</svg>
				</button>
			...
			<div class="slash-commands-section">
				...
				<div class="slash-commands-list" id="promptSnippetsList">
					...
					<div class="slash-command-item add-snippet-item" data-action="showAddSnippetForm">
					...
					<div class="form-buttons">
							<button class="btn primary" data-action="saveCustomSnippet">Save Command</button>
							<button class="btn secondary" data-action="hideAddSnippetForm">Cancel</button>
					</div>
				</div>

					<!-- Built-in Snippets -->
					<div class="slash-command-item prompt-snippet-item" data-action="usePromptSnippet" data-snippet-id="performance-analysis">
						<div class="slash-command-icon">
					...
					<div class="slash-command-item prompt-snippet-item" data-action="usePromptSnippet" data-snippet-id="security-review">
						<div class="slash-command-icon">
					...
					<div class="slash-command-item prompt-snippet-item" data-action="usePromptSnippet" data-snippet-id="implementation-review">
						<div class="slash-command-icon">
					...
					<div class="slash-command-item prompt-snippet-item" data-action="usePromptSnippet" data-snippet-id="code-explanation">
						<div class="slash-command-icon">
					...
					<div class="slash-command-item prompt-snippet-item" data-action="usePromptSnippet" data-snippet-id="bug-fix">
						<div class="slash-command-icon">
					...
					<div class="slash-command-item prompt-snippet-item" data-action="usePromptSnippet" data-snippet-id="refactor">
						<div class="slash-command-icon">
					...
					<div class="slash-command-item prompt-snippet-item" data-action="usePromptSnippet" data-snippet-id="test-generation">
						<div class="slash-command-icon">
					...
					<div class="slash-command-item prompt-snippet-item" data-action="usePromptSnippet" data-snippet-id="documentation">
						<div class="slash-command-icon">
			...
			<div class="slash-commands-section">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="add-dir">
					<div class="slash-command-icon">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="clear">
					<div class="slash-command-icon">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="compact">
					<div class="slash-command-icon">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="config">
					<div class="slash-command-icon">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="cost">
					<div class="slash-command-icon">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="doctor">
					<div class="slash-command-icon">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="help">
					<div class="slash-command-icon">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="init">
					<div class="slash-command-icon">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="login">
					<div class="slash-command-icon">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="logout">
					<div class="slash-command-icon">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="model">
					<div class="slash-command-icon">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="permissions">
					<div class="slash-command-icon">
						<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 1L3 5v6c0 5.55 3.84 10.74 9 12 5.16-1.26 9-6.45 9-12V5l-9-4zm0 10.99h7c-.53 4.12-3.28 7.79-7 8.94V12H5V6.3l7-3.11v8.8z"/></svg>
					</div>
					<div class="slash-command-content">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="review">
					<div class="slash-command-icon">
						<svg width="14" height="14" viewBox="0 0 24 24" fill="currentColor"><path d="M12 4.5C7 4.5 2.73 7.61 1 12c1.73 4.39 6 7.5 11 7.5s9.27-3.11 11-7.5c-1.73-4.39-6-7.5-11-7.5zM12 17c-2.76 0-5-2.24-5-5s2.24-5 5-5 5 2.24 5 5-2.24 5-5 5zm0-8c-1.66 0-3 1.34-3 3s1.34 3 3 3 3-1.34 3-3-1.34-3-3-3z"/></svg>
					</div>
					<div class="slash-command-content">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="status">
					<div class="slash-command-icon">
				...
				<div class="slash-command-item" data-action="executeSlashCommand" data-command="usage">
					<div class="slash-command-icon">
	...
	${getScript(isTelemetryEnabled, nonce)}
